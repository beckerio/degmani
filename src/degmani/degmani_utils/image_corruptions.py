...
Code is modified by authors of this paper/repo to support arbitrary image sizes.
...
def frost(x, severity=1):
    ...
    w, h = x.size  # x ist PIL-Image
    frost_im = cv2.resize(frost_im, (w, h))
