...
def _binary_clf_curve(y_true, y_score, pos_label=None, sample_weight=None):
    ...
    fps = _stable_cumsum(y_neg * weight)[threshold_idxs]
...
# Compute MMD between two feature sets
def compute_mmd(features_01, features_02, gamma=1.0):
    K_real = rbf_kernel(features_01, features_01, gamma=gamma)
    K_fake = rbf_kernel(features_02, features_02, gamma=gamma)
    K_cross = rbf_kernel(features_01, features_02, gamma=gamma)
